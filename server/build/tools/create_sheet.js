        ...
        try {
            ...
            return {
                content: [
                    {
                        type: "text",
                        text: `Create sheet failed: ${errorMessage(error)}`,
                    },
                ],
                isError: true,
            };
