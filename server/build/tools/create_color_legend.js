...
export function registerCreateColorLegendTool(server) {
    server.tool("create_color_legend", "Color-code elements by parameter and place a color legend on a sheet.", {
        ...
        categories: z.array(z.string()).optional().describe("Categories to include (e.g. Rooms, Walls, Doors). Default: Rooms."),
        colorScheme: z.enum(["auto", "gradient", "custom"]).optional().describe("'auto' (default), 'gradient' (blue-red ramp), or 'custom'."),
