        ...
        try {
            ...
            return {
                content: [
                    {
                        type: "text",
                        text: `Create view filter failed: ${errorMessage(error)}`,
                    },
                ],
                isError: true,
            };
