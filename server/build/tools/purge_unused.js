        ...
        try {
            ...
            return {
                content: [
                    {
                        type: "text",
                        text: `Purge unused failed: ${errorMessage(error)}`,
                    },
                ],
                isError: true,
            };
