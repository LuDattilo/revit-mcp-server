        ...
        try {
            ...
            return {
                content: [
                    {
                        type: "text",
                        text: `save selection failed: ${errorMessage(error)}`,
                    },
                ],
                isError: true,
            };
