        ...
        try {
            ...
            return {
                content: [
                    {
                        type: "text",
                        text: `Create array failed: ${errorMessage(error)}`,
                    },
                ],
                isError: true,
            };
